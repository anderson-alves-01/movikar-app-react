        ...
        <div className="text-center">
          ...
          <div className="bg-black bg-opacity-30 backdrop-blur-sm rounded-2xl p-6 mb-12 max-w-4xl mx-auto">
            <p className="text-xl md:text-2xl text-white font-semibold leading-relaxed">
              <span className="text-blue-400 font-bold">Conectamos pessoas que precisam de um carro</span> com <span className="text-secondary font-bold">donos que querem compartilhar</span>. 
