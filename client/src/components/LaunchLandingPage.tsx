        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Transforme seu carro parado em renda extra. Você cadastra o
                carro em poucos minutos, define a disponibilidade e recebe por
                cada aluguel, sem se preocupar com burocracia.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Alcance quem quer alugar perto de você
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Você escolhe preço e quando alugar
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Aproveite o tempo em que o carro ficaria parado
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-teal-50 rounded-lg shadow-xl p-8 overflow-hidden relative">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-center mb-4">
                  Transforme seu carro em renda
                </h3>
                <p className="text-gray-600 text-center mb-6">
                  Você cadastra o carro em poucos minutos, define a
                  disponibilidade e recebe por cada aluguel.
                </p>
                <Button
                  id="locadores-cta"
