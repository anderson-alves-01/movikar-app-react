...
import {
  ...
  CoinSparkleEffect,
} from "@/components/coin-animation";
      ...
      if (error) {
        ...
        try {
          ...
          toast({
            ...
            description:
              "Pagamento processado, mas houve erro ao creditar moedas. Entre em contato com o suporte.",
            variant: "destructive",
          });
        }
      }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      >
        {loading
          ? "Processando..."
          : `Comprar por ${(finalPrice || packageInfo.price).toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}`}
      </Button>
    </form>
  );
};
  ...
  const getCouponDiscount = (pkg: CoinPackage) => {
    ...
    if (appliedCoupon.coupon.discountType === "percentage") {
      discountAmount = Math.round(
        (priceInCents * appliedCoupon.coupon.discountValue) / 100,
      );
            ...
            <Card>
              ...
              <CardContent>
                <div
                  ...
                  data-testid="text-available-coins"
                >
                  <CoinCounterAnimation
            ...
            <TabsContent value="purchase" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Use moedas para desbloquear informações de contato dos
                    proprietários de veículos. Cada contato custa 200 moedas e
                  ...
                  <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
                    <CardHeader className="pb-3">
                      ...
                      <CardDescription className="text-green-700">
                        Tem um código promocional? Digite aqui para aplicar
                      ...
                      {appliedCoupon && appliedCoupon.isValid ? (
                        <div className="bg-green-100 border border-green-300 rounded-lg p-4">
                          ...
                          <p className="text-xs text-green-600 mt-2">
                            Código: {appliedCoupon.coupon.code}
                          </p>
                        </div>
                      ) : (
                        ...
                        <CardDescription>
                          ...
                          {(() => {
                            ...
                            if (discount) {
                              ...
                              return selectedPackage.price.toLocaleString(
                                "pt-BR",
                                { style: "currency", currency: "BRL" },
                              );
                            }
                      ...
                      <CardContent>
                        <Elements stripe={stripePromise}>
                          <CoinPurchaseForm
                            ...
                            finalPrice={(() => {
                              const discount =
                                getCouponDiscount(selectedPackage);
                              return discount
                                ? discount.finalPrice
                ...
                <CardContent>
                  {unlocksLoading ? (
                          ...
                          <CardContent className="p-4">
                            <div className="flex justify-between items-start mb-3">
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Veículo #{unlock.vehicleId} •{" "}
                                  {unlock.coinsSpent} moedas gastas
                                </p>
                              </div>
                              <Badge
                                variant={
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm">
                                  {unlock.contactInfo.phone}
                                </span>
                              </div>
                              <div className="flex items-center gap-2">
                                <Mail className="h-4 w-4 text-muted-foreground" />
                                <span className="text-sm">
                                  {unlock.contactInfo.email}
                                </span>
                              </div>
                            </div>
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-muted-foreground">
                        Nenhum contato desbloqueado ainda
                      </p>
                      <p className="text-sm text-muted-foreground mt-2">
                        Desbloqueie contatos de proprietários para entrar em
                        contato diretamente
                      </p>
                    </div>
                  )}
